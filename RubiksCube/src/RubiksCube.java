...
public class RubiksCube extends Application {
   ...
   // private static final int[] FR   = new int[]{BLUE, RED, GRAY, GRAY, GRAY, GRAY};
    ...
    private static final Point3D pFLD   = new Point3D(0,  0.6, -0.6);
    //private static final Point3D pFD    = new Point3D(   0,  1.1, -1.1);
    private static final Point3D pFRD   = new Point3D( 1.1,  0.6, -0.6);
    ...
    private static final Point3D pFLU   = new Point3D(0, -0.6, -0.6);
    //private static final Point3D pFU    = new Point3D(   0, -1.1, -1.1);
    private static final Point3D pFRU   = new Point3D( 1.1, -0.6, -0.6);
    //BACKUP
    /*
    ...
    private static final Point3D pBLD   = new Point3D(0,  0.6, 0.6);
    //private static final Point3D pBD    = new Point3D(   0,  1.1, 1.1);
    private static final Point3D pBRD   = new Point3D( 1.1,  0.6, 0.6);
    ...
    private static final Point3D pBLU   = new Point3D(0, -0.6, 0.6);
    //private static final Point3D pBU    = new Point3D(   0, -1.1, 1.1);
    private static final Point3D pBRU   = new Point3D( 1.1, -0.6, 0.6);
